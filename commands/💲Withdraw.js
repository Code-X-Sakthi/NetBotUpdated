...
var buttons = [[{title:"Watch Netflix Without Login", url:"http://t.me/NovaTestingNo2_Bot/Netflix"}],[{title:"Netflix", command:"net"}],[{title:"🆕 YouTube Premium ( On Mail )", command:"GYT"}],[{title:" Amazon Prime", command:"ama"}],[{title:" Express Vpn", command:"vpn"}],[{title:" Crunchyroll", command:"crun"}]]
